...
final class FleetEventTests: XCTestCase {
    ...
    func testBasicInitialization() {
        ...
        let event = FleetEvent(title: "Oil Change", vehicleName: "Tesla Model 3", date: date, category: .maintenance)
    ...
    func testAutoGeneratedID() {
        let e1 = FleetEvent(title: "A", vehicleName: "B", date: Date(), category: .registration)
        let e2 = FleetEvent(title: "A", vehicleName: "B", date: Date(), category: .registration)
    ...
    func testRegistrationCategory() {
        let event = FleetEvent(title: "Renewal", vehicleName: "Car", date: Date(), category: .registration)
        XCTAssertEqual(event.category, .registration)
        XCTAssertEqual(event.category.rawValue, "registration")
    }

    func testInsuranceCategory() {
        let event = FleetEvent(title: "Renewal", vehicleName: "Car", date: Date(), category: .insurance)
        XCTAssertEqual(event.category, .insurance)
        XCTAssertEqual(event.category.rawValue, "insurance")
    }

    func testMaintenanceCategory() {
        let event = FleetEvent(title: "Oil Change", vehicleName: "Car", date: Date(), category: .maintenance)
        XCTAssertEqual(event.category, .maintenance)
        XCTAssertEqual(event.category.rawValue, "maintenance")
    }

    func testRecallCategory() {
        let event = FleetEvent(title: "Recall", vehicleName: "Car", date: Date(), category: .recall)
    ...
    func testDayFormatting() {
        ...
        let event = FleetEvent(title: "Test", vehicleName: "Car", date: date, category: .maintenance)
    ...
    func testEmptyTitle() {
        let event = FleetEvent(title: "", vehicleName: "", date: Date(), category: .maintenance)
    ...
    func testVeryLongTitle() {
        ...
        let event = FleetEvent(title: longTitle, vehicleName: "Car", date: Date(), category: .maintenance)
        XCTAssertEqual(event.title.count, 10_000)
    }

    func testUnicodeInTitle() {
        let event = FleetEvent(title: "\u{1F527} Maintenance", vehicleName: "\u{1F697} My Car", date: Date(), category: .maintenance)
        XCTAssertTrue(event.title.contains("\u{1F527}"))
        XCTAssertTrue(event.vehicleName.contains("\u{1F697}"))
    }

    func testEpochDate() {
        let event = FleetEvent(title: "Test", vehicleName: "Car", date: Date(timeIntervalSince1970: 0), category: .maintenance)
        XCTAssertFalse(event.day.isEmpty)
        XCTAssertFalse(event.month.isEmpty)
    }

    func testFarFutureDate() {
        let event = FleetEvent(title: "Test", vehicleName: "Car", date: Date(timeIntervalSince1970: 4_000_000_000), category: .maintenance)
        XCTAssertFalse(event.day.isEmpty)
        XCTAssertFalse(event.month.isEmpty)
    }
}
