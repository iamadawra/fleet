...
final class FleetEventTests: XCTestCase {
    ...
    func testBasicInitialization() {
        ...
        let vehicleId = UUID()
        let event = FleetEvent(title: "Oil Change", vehicleName: "Tesla Model 3", date: date, category: .maintenance, vehicleId: vehicleId)
        ...
        XCTAssertEqual(event.vehicleId, vehicleId)
    }
